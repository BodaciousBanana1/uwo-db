+++
title = "Biological survey of the Extreme North"
date = 2026-05-22
...
advance = 0
difficulty = 5
skills = [{ name = "Recognition", level = 4 }, { name = "Geography", level = 6 }, { name = "Nordic", level = 1 }]
variants = [{ city = "St. Petersburg", guild_type = "Adventurer", id = "99990023", slug = "biological-survey-of-the-extreme-north" }]
steps = []
